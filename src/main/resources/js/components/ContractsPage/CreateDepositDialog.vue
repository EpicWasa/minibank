...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                if(!this.initialSum || this.rateName===' '|| this.accountName===' '|| this.initialSum > this.accounts.filter(elem=>elem.name===this.accountName)[0].amount || this.initialSum<1 ){
                    return;
                }
                const deposit = {
            ...
            getRates(){
                ...
                if(this.accountName!==' ') {
                    ...
                    currRates = this.rates.filter(item=>item.currency.name === acc.currency.name&&item.type==='deposit');
                }
